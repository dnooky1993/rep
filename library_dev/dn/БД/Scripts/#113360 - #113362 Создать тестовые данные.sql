...
--- создание документа DIGITIZED_DOCUMENT. Ќе забыть указать тот же uid, что и в c_dn_justification_check
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(1${id}, 'DIGITIZED_DOCUMENT', ${id}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false); -- проставлено deleted на первом шаге
...
--- создание документа HOSPITAL_DISCHARGE_DOCUMENT. Ќе забыть указать тот же uid, что и в c_dn_justification_check
...
--- создание документа PREVENTIVE_EXAMINATION_DOCUMENT. Ќе забыть указать тот же uid, что и в c_dn_justification_check
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(1${id}, 'DIGITIZED_DOCUMENT', ${id}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false); -- проставлено deleted на первом шаге
