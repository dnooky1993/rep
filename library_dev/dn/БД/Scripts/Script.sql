...
INSERT INTO f_attachment_event (id, attachment_id, event_date, document_uid, employee_id, mkb10_id, speciality_code, medical_specialization_id, reason_id, diagnosis, no_doctor) VALUES(4${#TestCase#areaId}, 4${#TestCase#areaId}, '2021-05-31 09:41:00.646', 'c5564c1c-2d94-460b-b36b-9e040d147ac2', '14382', 128287720, '69', 125676819, 4, 'комментарий', false);

--- создание тасок и связанных данных
--- задачи для проверки шага 1
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(1${#TestCase#areaId}, 'HOSPITAL_DISCHARGE_DOCUMENT', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false); -- проставлено deleted на первом шаге
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(2${#TestCase#areaId}, 'AREA', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false); -- проставлено deleted на первом шаге
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(3${#TestCase#areaId}, 'DIGITIZED_DOCUMENT', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false); -- проставлено deleted на первом шаге
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(4${#TestCase#areaId}, 'CONTINUED_OBS', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false); -- проставлено deleted на первом шаге
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(5${#TestCase#areaId}, 'HOSPITAL_DISCHARGE_DOCUMENT', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', '2021-07-02 15:37:59.000', NULL, 30, false); --- шаг 1 не обработает, т.к. закрыта
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(8${#TestCase#areaId}, 'AREA', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', NULL, NULL, 30, true); --- шаг 1 не обработает, т.к. deleted = true
...
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(9${#TestCase#areaId}, 'HOSPITAL_DISCHARGE_DOCUMENT', ${#TestCase#patientId}, '2021-07-02 15:37:59.000', '2021-07-02 15:37:59.000', NULL, 30, false); --- задача, по которой два диагноза и один не обработан
...
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('2edb2286-d140-4857-b2b5-02a29873${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Выписной эпикриз', false, NULL); --- документ не обрабатывается на шаге 2, есть задачи
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('9f133c19-f164-423c-88f0-a9628b1e2${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Оцифрованная карта № 030/У', false, NULL); --- документ не обрабатывается на шаге 2, есть задачи
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('13${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Оцифрованная карта № 030/У', false, NULL); --- документ обрабатывает у пациента определена группа ДН 1023 DNA0149, т.к. нет задач
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('3${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Выписной эпикриз', false, NULL); --- документ обрабатывает у пациента определена группа ДН 2 DNA0002, т.к. нет задач
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('2${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Оцифрованная карта № 030/У', true, '2021-02-24 17:13:49.000'); --- документ не обрабатывается на шаге 2, для документа нет задач, но deprecated = true
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('2edb2286-d140-4857-b2b5-02a29874${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Выписной эпикриз', false, NULL); --- документ обрабатывает у пациента определена только группа ДН 2 DNA0002, т.к. по второму диагнозу есть задачи
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('10${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Протокол профосмотра/диспансеризации', false, NULL); --- документ не обрабатывается на шаге 2, есть задачи
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('11${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Протокол профосмотра/диспансеризации', false, NULL); --- документ обрабатывается на шаге 2, нет задачи
INSERT INTO f_document (document_id, patient_id, signed_date, "type", deprecated, deprecated_date) VALUES('12${#TestCase#areaId}', ${#TestCase#patientId}, '2021-02-24 17:13:49.000', 'Протокол профосмотра/диспансеризации', false, NULL); --- документ обрабатывается на шаге 2, нет задачи
...
INSERT INTO l_document_mkb10 (document_id, mkb10_id) VALUES('13${#TestCase#areaId}', 128290661); --- есть взрослые и детские группы ДН
INSERT INTO l_document_mkb10 (document_id, mkb10_id) VALUES('2${#TestCase#areaId}', 128290661);
INSERT INTO l_document_mkb10 (document_id, mkb10_id) VALUES('3${#TestCase#areaId}', 128287720); --- есть только взрослые группы ДН
INSERT INTO l_document_mkb10 (document_id, mkb10_id) VALUES('2edb2286-d140-4857-b2b5-02a29874${#TestCase#areaId}', 128290661); --- есть взрослые и детские группы ДН
INSERT INTO l_document_mkb10 (document_id, mkb10_id) VALUES('2edb2286-d140-4857-b2b5-02a29874${#TestCase#areaId}', 128287720); --- есть только взрослые группы ДН
