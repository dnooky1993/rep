...
INSERT INTO f_task (id, "type", patient_id, opened, closed, assignee, priority, deleted) VALUES(1${id}, 'HOSPITAL_DISCHARGE_DOCUMENT', ${id}, '2021-07-02 15:37:59.000', NULL, NULL, 30, false);

INSERT INTO f_document_hospital_discharge_task (id, uid) VALUES(${id}, '1${id}');
